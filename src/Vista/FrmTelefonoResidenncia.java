 ...
 * @author Stevia
 */
public class FrmTelefonoResidenncia extends javax.swing.JFrame {

    /**
     * Creates new form FrmVista
     */
    public FrmTelefonoResidenncia() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FrmTelefonoResidenncia.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FrmTelefonoResidenncia().setVisible(true);
            }
        });
    }
